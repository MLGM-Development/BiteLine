...
//Query per l'inserimento dell'admin nel database
$query = $mysqli->prepare("INSERT INTO admins (name, email, password) VALUES (?, ?, ?)");
$query->bind_param("sss", $name, $_POST["email"], $hash);
$query->execute();
$query->close();
