...
$uploadDir = __DIR__ . '/../../../assets/media/images/restaurants/';
    ...
    <div class="container">
        ...
        <div class="contact-section glass-morphism">
            ...
            <div class="section-content">
                <span class="badge fade-in-up">ristorante</span>
                <h1 class="fade-in-up">Registrazione</h1>
                <p class="fade-in-up stagger-delay-1">Inserisci i dati richiesti relativi alla tua società per poter iniziare ad utilizzare i servizi di BiteLine</p>
                    ...
                    <div class="form-group image-upload-container">
                        <div id="imageUploadArea" class="image-upload-area" tabindex="0">
                            ...
                            <div id="uploadPlaceholder" class="upload-placeholder">
                                ...
                                <span>Formati supportati: JPG, PNG, GIF</span>
                            </div>
                        ...
                        <label for="imageUpload">Logo del ristorante</label>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <input type="text" id="name" placeholder=" " name="resName" required>
                            <label for="name">Nome ristorante</label>
                        </div>
                        <div class="form-group">
                            <input type="email" id="email" placeholder=" " name="resMail" required>
                            <label for="email">Email Ristorante</label>
                        </div>
                    </div>

                    <div class="form-group">
                        <input type="text" id="subject" placeholder=" " name="address" required>
                        <label for="subject">Indirizzo</label>
                    </div>
